...
static asn_TYPE_member_t asn_MBR_OMD_DAR_DATAOPTION_A_ResultNormal_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct OMD_DAR_DATAOPTION_A_ResultNormal, objMethDescr),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct OMD_DAR_DATAOPTION_A_ResultNormal, dar),
	...
	{ ATF_POINTER, 1, offsetof(struct OMD_DAR_DATAOPTION_A_ResultNormal, data),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct OMD_DAR_DATAOPTION_A_ResultNormal, a_ResultNormal),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
...
static const int asn_MAP_OMD_DAR_DATAOPTION_A_ResultNormal_oms_1[] = { 2 };
static const ber_tlv_tag_t asn_DEF_OMD_DAR_DATAOPTION_A_ResultNormal_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_OMD_DAR_DATAOPTION_A_ResultNormal_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (10 << 2)), 1, 0, 0 }, /* dar */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 1 }, /* objMethDescr */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 3, -1, 0 }, /* a-ResultNormal */
...
static asn_SEQUENCE_specifics_t asn_SPC_OMD_DAR_DATAOPTION_A_ResultNormal_specs_1 = {
	sizeof(struct OMD_DAR_DATAOPTION_A_ResultNormal),
	offsetof(struct OMD_DAR_DATAOPTION_A_ResultNormal, _asn_ctx),
	asn_MAP_OMD_DAR_DATAOPTION_A_ResultNormal_tag2el_1,
	43,	/* Count of tags in the map */
	asn_MAP_OMD_DAR_DATAOPTION_A_ResultNormal_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_OMD_DAR_DATAOPTION_A_ResultNormal = {
	...
	asn_DEF_OMD_DAR_DATAOPTION_A_ResultNormal_tags_1,
	sizeof(asn_DEF_OMD_DAR_DATAOPTION_A_ResultNormal_tags_1)
		/sizeof(asn_DEF_OMD_DAR_DATAOPTION_A_ResultNormal_tags_1[0]), /* 1 */
	asn_DEF_OMD_DAR_DATAOPTION_A_ResultNormal_tags_1,	/* Same as above */
	sizeof(asn_DEF_OMD_DAR_DATAOPTION_A_ResultNormal_tags_1)
		/sizeof(asn_DEF_OMD_DAR_DATAOPTION_A_ResultNormal_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_OMD_DAR_DATAOPTION_A_ResultNormal_1,
	4,	/* Elements count */
	&asn_SPC_OMD_DAR_DATAOPTION_A_ResultNormal_specs_1	/* Additional specs */
};
