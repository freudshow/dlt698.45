...
static asn_TYPE_member_t asn_MBR_OmdDarDataOPTIONAL_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct OmdDarDataOPTIONAL, objMethDescr),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct OmdDarDataOPTIONAL, dar),
	...
	{ ATF_POINTER, 1, offsetof(struct OmdDarDataOPTIONAL, data),
...
static const int asn_MAP_OmdDarDataOPTIONAL_oms_1[] = { 2 };
static const ber_tlv_tag_t asn_DEF_OmdDarDataOPTIONAL_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_OmdDarDataOPTIONAL_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_OmdDarDataOPTIONAL_specs_1 = {
	sizeof(struct OmdDarDataOPTIONAL),
	offsetof(struct OmdDarDataOPTIONAL, _asn_ctx),
	asn_MAP_OmdDarDataOPTIONAL_tag2el_1,
	42,	/* Count of tags in the map */
	asn_MAP_OmdDarDataOPTIONAL_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_OmdDarDataOPTIONAL = {
	"OmdDarDataOPTIONAL",
	"OmdDarDataOPTIONAL",
	SEQUENCE_free,
	SEQUENCE_print,
	...
	asn_DEF_OmdDarDataOPTIONAL_tags_1,
	sizeof(asn_DEF_OmdDarDataOPTIONAL_tags_1)
		/sizeof(asn_DEF_OmdDarDataOPTIONAL_tags_1[0]), /* 1 */
	asn_DEF_OmdDarDataOPTIONAL_tags_1,	/* Same as above */
	sizeof(asn_DEF_OmdDarDataOPTIONAL_tags_1)
		/sizeof(asn_DEF_OmdDarDataOPTIONAL_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_OmdDarDataOPTIONAL_1,
	3,	/* Elements count */
	&asn_SPC_OmdDarDataOPTIONAL_specs_1	/* Additional specs */
};
