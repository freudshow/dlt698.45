...
static asn_TYPE_member_t asn_MBR_ActionRequestNormal_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ActionRequestNormal, prioInvID),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ActionRequestNormal, objMethDescr),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ActionRequestNormal, methArg),
...
static const ber_tlv_tag_t asn_DEF_ActionRequestNormal_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ActionRequestNormal_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 0, 0, 0 }, /* prioInvID */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, 0, 0 }, /* objMethDescr */
...
static asn_SEQUENCE_specifics_t asn_SPC_ActionRequestNormal_specs_1 = {
	sizeof(struct ActionRequestNormal),
	offsetof(struct ActionRequestNormal, _asn_ctx),
	asn_MAP_ActionRequestNormal_tag2el_1,
	42,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_ActionRequestNormal = {
	"ActionRequestNormal",
	"ActionRequestNormal",
	SEQUENCE_free,
	SEQUENCE_print,
	...
	asn_DEF_ActionRequestNormal_tags_1,
	sizeof(asn_DEF_ActionRequestNormal_tags_1)
		/sizeof(asn_DEF_ActionRequestNormal_tags_1[0]), /* 1 */
	asn_DEF_ActionRequestNormal_tags_1,	/* Same as above */
	sizeof(asn_DEF_ActionRequestNormal_tags_1)
		/sizeof(asn_DEF_ActionRequestNormal_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_ActionRequestNormal_1,
	3,	/* Elements count */
	&asn_SPC_ActionRequestNormal_specs_1	/* Additional specs */
};
